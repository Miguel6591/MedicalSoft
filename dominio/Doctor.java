...
public class Doctor {
	...
	private ImageIcon image=new ImageIcon(FramePrincipal.class.getResource(Messages.getString("Doctor.0"))); //$NON-NLS-1$
	
	public Doctor(String usuario, String contraseña, String nombre, String apellidos, String dni, int colegiado, int tlf
			,int movil, String direccion, int ext, String localidad, String email, int cp, String eCivil, String provincia
			,ArrayList<Paciente> pacientes,ArrayList<Consulta> consultas,ArrayList<Especialista> especialistas) {
		super();
