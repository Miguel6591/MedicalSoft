...
public class Paciente {
	...
	private ImageIcon image=new ImageIcon(FramePrincipal.class.getResource(Messages.getString("Paciente.0"))); //$NON-NLS-1$
	

	private String fechacimiento;
	
	
	public Paciente(String id,String nombre, String apellidos, String nacionalidad, String direccion, String municipio, String cp,
