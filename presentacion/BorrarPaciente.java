...
public class BorrarPaciente extends JFrame {
	...
	public BorrarPaciente(ArrayList<Paciente> pacientes) {
		...
		list.setBorder(new TitledBorder(null, Messages.getString("BorrarPaciente.11"), TitledBorder.LEADING, TitledBorder.TOP, null, SystemColor.textText)); //$NON-NLS-1$
		actualizarDatos();
	...
	public void actualizarDatos(){
		...
		for(int i=0;i<pacientes.size();i++){
			modelo.addElement(pacientes.get(i).getApellidos()+Messages.getString("BorrarPaciente.16")+pacientes.get(i).getNombre()); //$NON-NLS-1$
		}
	...
	private class ListListSelectionListener implements ListSelectionListener {
		public void valueChanged(ListSelectionEvent e) {
					...
					if(i==-1){
						...
						textN.setText(Messages.getString("BorrarPaciente.20") + pacientes.get(i).getId()); //$NON-NLS-1$
			}
		}
	}
