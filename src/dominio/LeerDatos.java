...
public class LeerDatos {
	...
	void leerPacientes(){
		try{
			f1=new File("src/txt/pacientes.txt"); 
			teclado= new Scanner(f1).useDelimiter("#"); 
	...
	void leerDoctores(){
		try{
			f1=new File("src/txt/doctores.txt");
	...
	void leerEspecialistas(){
		try{
			f1=new File("src/txt/especialistas.txt");
			teclado= new Scanner(f1).useDelimiter("#");
		}catch(FileNotFoundException e){
			 e.printStackTrace();
		}
	...
	void leerConsultas(){
		try{
			f1=new File("src/txt/consultas.txt"); 
			teclado= new Scanner(f1).useDelimiter("#");
		}catch(FileNotFoundException e){
			 e.printStackTrace();
		}
