...
public class AnadirConsulta extends JFrame {
	...
	public AnadirConsulta(Doctor doctor) {
		...
		textMotivo.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), Messages.getString("AnadirConsulta.8"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0))); //$NON-NLS-1$ //$NON-NLS-2$
